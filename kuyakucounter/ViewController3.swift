...
//          画面が変わった時に保存
    override func viewWillDisappear(_ animated: Bool) {
        ...
        UserDefaults.standard.set(countArray, forKey: "countPage3")
        UserDefaults.standard.set(kakurituArray, forKey: "kakurituPage3")
    }
//        画面が表示された時にデータを持ってくる
    override func viewWillAppear(_ animated: Bool) {
        if UserDefaults.standard.object(forKey: "countPage3") != nil{
            countArray = UserDefaults.standard.object(forKey: "countPage3") as! [Int]
            
        }
        if UserDefaults.standard.object(forKey: "kakurituPage3") != nil{
            kakurituArray = UserDefaults.standard.object(forKey: "kakurituPage3") as! [Double]
        }
    ...
    @IBAction func longPreas3(_ sender: Any) {
    countText3.text = "0"
...
//ボタンを押したらフラッシュさせる （classの外にあるから１つ入れれば大丈夫）
extension UIView {
